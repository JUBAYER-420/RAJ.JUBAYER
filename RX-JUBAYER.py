...
try:
    ...
    if "Bangladesh" not in ___ccc___:
       os.system('xdg-open https://github.com/JUBAYER-420/RAJ.JUBAYER')
...
try:
    os.system('clear')
    srv=requests.get('https://raw.githubusercontent.com/RX JUBAYER/SPIDER/main/srv.txt').text 
    if "update" in srv:
        os.system('clear')
        for j in range(3000):
            time.sleep(0.5)
...
def logo():
    os.system('clear')
    print(f"""                   {green}┏━━━━━━━━━━━━━━━━━━━┓{green}
                   {green}┃{white}{faltu}RX JUBAYER{pvt}{green}┃
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
\033[0;92m╔═╗╔╗ ╦╦═╗  \033[1;93m ╦╦ ╦╔╗ ╔═╗╦ ╦╔═╗╦═╗
\033[0;92m╠═╣╠╩╗║╠╦╝\033[1;92m───║║ ║╠╩╗╠═╣╚╦╝║╣ ╠╦╝
\033[0;92m╩ ╩╚═╝╩╩╚═  \033[1;95m╚╝╚═╝╚═╝╩ ╩ ╩ ╚═╝╩╚═
